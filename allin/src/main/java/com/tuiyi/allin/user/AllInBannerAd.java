 ...
 * @date 2020/11/20
 */
public class AllInBannerAd extends BaseAllInAd {

    private CustomBannerAd ad;
     ...
     */
    public AllInBannerAd(Activity activity, ViewGroup container, AdConfig adConfig, AllInAdListener adListener) {
        makeRequest(adConfig.placeId, adConfig.width, adConfig.height, SysInfoUtils.getDeviceInfo(activity), new AdNetCallBack() {
            ...
            public void loadSuccess(AdEntity entity) {
                ...
                ad = AdFactory.getBannerAd(getAdType(adSourceEntity), adConfig);
                if (ad == null) {
